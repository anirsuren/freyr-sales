...
BD members with Market Intel access can use Add person beside People tracked to follow a LinkedIn profile or re-follow someone they stopped following. Stop following asks for confirmation and changes only that member's visible people and posts; it does not remove the person from the team's collected records. Company/person images are stored when available; missing images are not evidence that a source was collected.
