  ...
  const requests: SolutionRequest[] = [
    {
      ...
      customer: "Takeda",
      opportunityIds: [],
      opportunityLabels: ["Freya.Label · Takeda (ARR)"],
      contactIds: [],
      contactNames: ["Yuki Tanaka"],
      status: "in_progress",
      requestedBy: "Margaret Whitfield",
      requestedAt: day(-9),
      neededBy: d(4),
      ...
      docs: [
        {
          id: "sd-s1-1",
          category: "customer",
          name: "Takeda RFP package",
          version: 1,
          addedBy: "Margaret Whitfield",
          addedAt: day(-9),
        },
        {
          id: "sd-s1-2",
          ...
          version: 1,
          addedBy: "Walter Hensley",
          addedAt: day(-7),
          assignedTo: "Walter Hensley",
        },
        {
          id: "sd-s1-3",
          category: "working",
      ...
      activity: [
        { at: day(-9), by: "Margaret Whitfield", what: "Requested this submission" },
        { at: day(-8), by: "Walter Hensley", what: "Picked it up" },
        { at: day(-2), by: "Walter Hensley", what: "Added Response draft v2" },
      ],
    },
    {
      id: "sr-sample-2",
      ...
      customer: "Novartis",
      opportunityIds: [],
      opportunityLabels: ["Freya.intelligence · Novartis (ARR)"],
      contactIds: [],
      contactNames: [],
      status: "completed",
      ...
      activity: [
        { at: day(-20), by: "Priya Raghavan", what: "Requested this presentation" },
        { at: day(-19), by: "Walter Hensley", what: "Picked it up" },
        { at: day(-7), by: "Walter Hensley", what: "Added Defense deck v3" },
        { at: day(-6), by: "Priya Raghavan", what: "Marked it completed" },
      ],
    },
    {
      id: "sr-sample-3",
      ref: "MTG-0001",
      kind: "meeting",
      title: "Technical deep-dive with Kenvue RA team",
      customer: "Kenvue",
      opportunityIds: [],
      opportunityLabels: [],
      contactIds: [],
      contactNames: ["Daniel Osei", "Sofia Marin"],
      status: "initiated",
      requestedBy: "Margaret Whitfield",
      requestedAt: day(-1),
      neededBy: d(7),
      meetingAt: day(7),
      attendees: ["Margaret Whitfield", "Daniel Osei", "Sofia Marin"],
      docs: [
        {
          id: "sd-s3-1",
          category: "working",
          ...
          addedBy: "Margaret Whitfield",
          addedAt: day(-1),
          ref: { requestId: "sr-sample-2", docId: "sd-s2-1" },
          note: "Reusing the Novartis defense deck as the base",
        },
      ],
      activity: [
        { at: day(-1), by: "Margaret Whitfield", what: "Requested this meeting" },
      ],
    },
    {
      id: "sr-sample-4",
      ...
      customer: "Opella",
      opportunityIds: [],
      opportunityLabels: ["Freya.Artwork · Opella (OTS)"],
      contactIds: [],
      contactNames: [],
      status: "initiated",
      requestedBy: "Ethan Brooks",
      requestedAt: day(-2),
      neededBy: d(10),
      docs: [],
      activity: [
        { at: day(-2), by: "Ethan Brooks", what: "Requested this submission" },
      ],
    },
  ];
  return { requests };
