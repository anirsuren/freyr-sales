...
export const RECORDINGS: Recording[] = [
  {
    ...
    summary:
      "Strong discovery call. Walter Hensley opened by referencing Dr. Mehta's FDA background and tied the conversation to the upcoming NDA timeline. Surfaced a clear pain around CTD dossier throughput and booked a follow-up with the NDA owner.",
    didWell: [
