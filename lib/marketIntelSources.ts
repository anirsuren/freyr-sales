...
export const COMPETITOR_SOURCES: CompanySource[] = [
  ...
  { id: "emergo", name: "Emergo by UL", li: ["emergobyul"], expect: "emergo", newsQ: "Emergo by UL", site: "emergobyul.com" },
  ...
  { id: "icon-plc", name: "ICON plc", li: ["icon-plc-2"], expect: "icon", newsQ: "ICON plc clinical", site: "iconplc.com" },
  { id: "ul-solutions", name: "UL Solutions", li: ["ulsolutions"], expect: "ul", newsQ: "UL Solutions", site: "ul.com" },
  ...
  { id: "arisglobal", name: "ArisGlobal", li: ["aris-global"], expect: "arisglobal", site: "arisglobal.com" },
  ...
  { id: "generis", name: "Generis", li: ["generis-enterprise-technology"], expect: "generis", newsQ: "Generis CARA", site: "generiscorp.com" },
  { id: "phlexglobal", name: "Phlexglobal", li: ["phlexglobaltmf"], expect: "phlex", site: "phlexglobal.com" },
  { id: "lorenz", name: "LORENZ", li: ["478461"], expect: "lorenz", newsQ: "LORENZ Life Sciences", site: "lorenz.cc" },
  ...
  { id: "dita-exchange", name: "Dita Exchange", li: ["dita-exchange-aps"], expect: "dita", newsQ: "Dita Exchange" },
...
export const COMPANY_SOURCES: CompanySource[] = [
  ...
  { id: "jj-medtech", name: "J&J Medtech", li: ["johnson-%26-johnson-medtech"], expect: "johnson", newsQ: "Johnson & Johnson MedTech", site: "jnjmedtech.com", divisions: ["MDV"] },
  ...
  { id: "zydus", name: "Zydus", li: ["zydusuniverse"], expect: "zydus", newsQ: "Zydus Lifesciences", site: "zyduslife.com", divisions: ["MPR", "CON"] },
  { id: "galderma", name: "Galderma", li: ["galderma-"], expect: "galderma", site: "galderma.com", divisions: ["MPR", "CON"] },
  { id: "curateq", name: "CuraTeQ", li: ["curateq"], expect: "curateq", newsQ: "CuraTeQ Biologics", site: "curateqbio.com", divisions: ["MPR"] },
  ...
  { id: "gideon", name: "Gedeon Richter", li: ["gedeonrichter", "gedeon-richter"], expect: "richter", newsQ: "Gedeon Richter", site: "gedeonrichter.com", divisions: ["MPR"] },
  ...
  { id: "sun-pharma", name: "Sun Pharma", li: ["sun-pharma"], expect: "sun pharma", site: "sunpharma.com", divisions: ["MPR"] },
  { id: "alkem", name: "Alkem", li: ["alkem-laboratories-ltd"], expect: "alkem", newsQ: "Alkem Laboratories", site: "alkemlabs.com", divisions: ["MPR"] },
