  ...
  return (
    <section className="rounded-xl border border-border-light bg-white p-5 shadow-card">
      <h2 className="flex items-center gap-2 text-[15px] font-semibold text-text-primary">
        ...
        Customers on {offeringName}
        <InfoHint text="Every account with this offering recorded against them, and the version they run of each piece in it. Click a row to open the account." />
      </h2>
        ...
        <table className="w-full min-w-[620px] text-left">
          <thead>
            <tr className="border-b border-border-light text-[10.5px] font-semibold uppercase tracking-[0.05em] text-text-tertiary">
              ...
              <th className="py-2 pr-4">Versions they run</th>
              <th className="py-2" />
            </tr>
          </thead>
