...
export function OfferingOverviewMain({
  ...
  return (
    <div className="min-w-0">
      ...
      {/* OFFERING AVAILABILITY — two facts, in the page's own section shape.
          The release-timeline rail that used to sit inside the brief drew
          three milestone cards from data no offering has yet, so it filled a
          screen with "No date yet" three times (Anir, Aug 7: "we don't need
          this entire flowchart… only these two things should be visible —
          what is currently available and what version"). The full roadmap
          still lives on the Roadmap tab, where an owner fills it in. */}
          ...
          <div>
            ...
            <div className="mt-1.5">
              {o.current_availability ? (
                ...
                <p className="text-[14px] text-text-secondary">Not recorded</p>
              )}
            </div>
          </div>
          <div>
      ...
      {/* Commercial performance is hidden on the live workspace: there are no
