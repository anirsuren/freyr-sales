      ...
      <Card className="w-full max-w-[420px] p-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-[13px] leading-relaxed text-text-secondary">
            {!authenticationReady
              ...
              : supabase
              ? "Sign in to the protected Freyr workspace. New accounts require owner approval before any sales data is visible."
        ...
        <p className="mt-5 text-center text-[11px] leading-relaxed text-text-tertiary">
          {!authenticationReady
            ...
            : supabase
            ? "Authentication is provided by Supabase. Workspace access is invite- or owner-approved."
            : authMode
